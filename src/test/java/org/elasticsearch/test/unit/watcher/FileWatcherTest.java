 ...
 * under the License.
 */
package org.elasticsearch.test.unit.watcher;
...
public class FileWatcherTest {
    ...
    private class RecordingChangeListener implements FileChangesListener {
        ...
        private String getRelativeFileName(File file) {
            return tempDir.toURI().relativize(file.toURI()).getPath();
        }
    ...
    public void testSimpleFileOperations() throws IOException {
        RecordingChangeListener changes = new RecordingChangeListener();
